...
if click is not None:
    ...
    @click.option("--device", "-d", type=click.STRING, default=None, help="Specify adb device to work with. "
                                                                          "By default first device will be used.")
    ...
    def main(
            ...
            partition: list[str], backup_all: bool, out: Path,
    ) -> None:
        _main(adb_host, adb_port, list_devices, list_partitions, device, partition, backup_all, out)
else:
...
def _main(
    ...
    for partition in partitions:
        ...
        backup.backup(partition, out, _progress)
